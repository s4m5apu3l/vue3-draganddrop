<template>
  <div class="row">
    ...
    <div class="col-4">
      ...
      <draggable :list="list2" class="list-group" group="a" item-key="name" :animation="300">
        <template #item="{ element }">
    ...
    <div class="col-4">
      ...
      <draggable :list="list3" class="list-group" group="a" item-key="name" :animation="300">
        <template #item="{ element }">
          <div class="list-group-item item">
            {{ element.name }}
          </div>
...
export default {
  ...
  methods: {
    ...
    add3: function() {
      this.list2.push({ name: "XDXDXDXD " + id, id: id++ });
    },
    replace3: function() {
      this.list2 = [{ name: "dsdsadsadsa", id: id++ }];
    }
  }
};
</script>
